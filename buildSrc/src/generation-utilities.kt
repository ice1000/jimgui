...
fun configPtr(name: String, nullable: Boolean = false) = PointerParam(name, "JImFontConfig", "ImFontConfig", if (nullable) "@Nullable" else "@NotNull", if (nullable) 0 else null)
fun stylePtr(name: String, nullable: Boolean = false) = PointerParam(name, "JImStyle", "ImGuiStyle", if (nullable) "@Nullable" else "@NotNull", if (nullable) 0 else null)
fun drawListPtr(name: String, nullable: Boolean = false) = PointerParam(name, "JImDrawList", "ImDrawList", if (nullable) "@Nullable" else "@NotNull", if (nullable) 0 else null)
fun boolPtr(name: String, nullable: Boolean = false) = PointerParam(name, "NativeBool", "bool", if (nullable) "@Nullable" else "@NotNull", if (nullable) 0 else null)
fun floatPtr(name: String, nullable: Boolean = false) = PointerParam(name, "NativeFloat", "float", if (nullable) "@Nullable" else "@NotNull", if (nullable) 0 else null)
fun doublePtr(name: String, nullable: Boolean = false) = PointerParam(name, "NativeDouble", "double", if (nullable) "@Nullable" else "@NotNull", if (nullable) 0 else null)
