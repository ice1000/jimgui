...
public class Demo {
    ...
    JImGuiUtil.runWithinPer(20000, 15, imGui -> {
      ...
      if (imGui.collapsingHeader("Widgets")) {
        if (imGui.treeNode("Basic")) {
          if (imGui.button("Button")) clicked.increaseValue(1);
  ...
  private static void showExampleAppFixedOverlay(@NotNull JImGui imGui, @NotNull NativeBool openPtr) {
    ...
    if (corner != -1) imGui.setNextWindowPos(windowPosX, windowPosY, JImCond.Always, windowPosPivotX, windowPosPivotY);
  ...
  @SuppressWarnings("AccessStaticViaInstance") private static void showExampleAppMainMenuBar(@NotNull JImGui imGui) {
  ...
  @SuppressWarnings("AccessStaticViaInstance") private static void showExampleAppWindowTitles(@NotNull JImGui imGui) {
    ...
    imGui.begin("Animated title " + "|/-\\".charAt((int) (millis / 0.25f) & 3) + " " + millis + "###Animated title");
    imGui.text("This window has a changing title.");
    imGui.end();
  }

  @SuppressWarnings("AccessStaticViaInstance") private static void showExampleMenuFile(@NotNull JImGui imGui) {
  ...
  @SuppressWarnings("AccessStaticViaInstance") private static void showUserGuide(@NotNull JImGui imGui) {
