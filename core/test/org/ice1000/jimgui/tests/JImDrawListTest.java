...
public class JImDrawListTest {
  ...
  @SuppressWarnings("AccessStaticViaInstance") public static void main(@NotNull String @NotNull ... args) {
    JniLoader.load();
    JImGuiUtil.runWithinPer(5000, 15, imGui -> {
      ...
      windowDrawList.addText(30,
          ...
          cursorPosY + 22,
          Color.BLUE.getRGB(),
          "I XiHuan Reiuji Utsuho forever\nQAQ");
      int rgb = Color.GREEN.getRGB();
      windowDrawList.addCircle(cursorPosX + 250, cursorPosY + 150, 50, rgb, 100);
      windowDrawList.addText(72, cursorPosX + 230, cursorPosY + 120, rgb, "6");
    });
  }
}
