...
public class JImGuiTest {
  @BeforeClass @TestOnly public static void useAlternativeJniLibAndCheckHeadless() {
  ...
  @Test public void jniInitialization() throws @NotNull NoSuchFieldException, @NotNull IllegalAccessException {
  ...
  @Test(expected = IllegalStateException.class) public void jniDisposal() {
