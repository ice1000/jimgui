...
"""
  ...
  private val functions = listOf(
      ...
      Fun.private("addImageRounded",
          ...
          nativeObjectPtr),
      Fun.private("addBezierCubic",
          pos("p1"), pos("p2"), pos("p3"),
          pos("p4"), u32, thickness, numSegments(0),
          nativeObjectPtr),
      Fun.private("addBezierQuadratic",
          pos("p1"), pos("p2"), pos("p3"),
          u32, thickness, numSegments(0),
          nativeObjectPtr),
      ...
      Fun.private("pathBezierCubicCurveTo",
          pos("p2"), pos("p3"), pos("p4"),
          numSegments(0),
          nativeObjectPtr),
      Fun.private("pathBezierQuadraticCurveTo",
          pos("p2"), pos("p3"),
          numSegments(0),
          nativeObjectPtr),
